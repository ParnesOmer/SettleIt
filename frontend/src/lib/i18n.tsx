...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    "room.chipNudge": "Anything to add? The more everyone shares, the smarter the ideas.",
    "room.chipNudgeCta": "Share in Chat",
  ...
  he: {
    ...
    "room.chipNudge": "יש עוד מה להוסיף? ככל שתשתפו יותר, הרעיונות יהיו טובים יותר.",
    "room.chipNudgeCta": "שתפו בצ'אט",
